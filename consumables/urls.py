...
urlpatterns = patterns('',
                       ...
                       #url(r'^stockin/$', ConsumablesStockinIndexView.as_view(), name='stockin_index'),
                       url(r'^(?P<pk>\d+)/stockin_new/$', ConsumablesStockinNewView.as_view(), name='stockin_new'),
                       url(r'^(?P<pk>\d+)/stockout_new/$', ConsumablesStockoutNewView.as_view(), name='stockout_new'),
